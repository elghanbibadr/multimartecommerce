...
const NewArrivals = () => {
  ...
  useEffect(() => {
    if (products.length > 0) {
      const filteredProducts = products.filter(({ item }) => item.category === 'mobile' || item.category==="wireless");
  ...
  return (
    <>
    <h2 className='text-primarycolor text-3xl mt-20 text-center font-medium'>New Arrivals</h2>
